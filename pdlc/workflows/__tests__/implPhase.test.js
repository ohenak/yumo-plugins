...
// affected by buildFinalReport's widened field list". Nothing about Phase I's
...
describe("RLH-REPORT-01-impl", () => {
  ...
  it("RLH-REPORT-01-impl: the final report carries §4.7's four new fields, each in its domain", async () => {
