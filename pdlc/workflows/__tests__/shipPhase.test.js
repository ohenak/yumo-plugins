...
// affected by buildFinalReport's widened field list". Nothing about Phase PUB's
...
describe("RLH-REPORT-01-ship", () => {
  ...
  it("RLH-REPORT-01-ship: the final report carries §4.7's four new fields, each in its domain", async () => {
    const result = await main(args());
    expect(result.outcome).toBe("success");
