...
/** The five capability keys `driftCapabilities.js` probes (TSPEC §1.3 clause 1). */
export const KNOWN_CAPABILITY_KEYS = Object.freeze(["bash", "git", "hash", "python", "uid-nonroot"]);
