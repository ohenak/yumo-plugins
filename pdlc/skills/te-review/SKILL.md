...
This is the last section of this SKILL, and it describes the **last section of your cross-review file**. After `## Recommendation` — and only once every other section of `docs/{feature-name}/CROSS-REVIEW-test-engineer-{DOCUMENT-TYPE}[-v{N}].md` is written — append a `## Verdict` section in exactly this grammar:
