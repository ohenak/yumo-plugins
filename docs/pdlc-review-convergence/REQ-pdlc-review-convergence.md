...
finding, and all six findings below lie in text v1.5 added — five of them in the **refusal path** v1.5
introduced to close round 6's dead end. One is High, and both panels filed it independently.
