...
| Field | Value |
|---|---|
| Upstream | REQ → FSPEC → **TSPEC** — `docs/pdlc-learnings-injection/FSPEC-pdlc-learnings-injection.md` (v0.14); `REQ-pdlc-learnings-injection.md` (v0.10); `docs/_constraints/DOMAIN-CONSTRAINTS.md` |
