...
| T33 | — | [manual] Operator observations that no suite can make: AT-3.1's transcript half (tool-invocation sequence of length 1), AT-3.2, AT-3.4, AT-3.5, AT-3.6's out-of-range refusal over a temp plugin-root fixture, and AT-5.3's probe-CLI invocation from the surviving repo path | — | — | 27 | T30 | ✅ (manual observations recorded; PENDING-OPERATOR note) |
