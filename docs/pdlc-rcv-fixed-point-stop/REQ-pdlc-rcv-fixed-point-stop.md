...
| Predecessor | `docs/pdlc-review-convergence/REQ-pdlc-review-convergence.md` v1.8 (**superseded 2026-08-01**), via `docs/pdlc-rcv-budget-stop/REQ-pdlc-rcv-budget-stop.md` v1.0 — this REQ carries that document's REQ-RCV-02 unchanged in substance. |
...
identity (R-9) to `docs/pdlc-review-convergence-calibration/REQ-pdlc-review-convergence-calibration.md`;
