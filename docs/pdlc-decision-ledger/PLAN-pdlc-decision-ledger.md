...
| Field | Value |
|---|---|
| Upstream | `REQ → FSPEC → TSPEC → DECISIONS → **PLAN**` (`REQ-pdlc-decision-ledger.md` v1.9 `sha256:ce6b133f…3c7b7c`, `FSPEC-pdlc-decision-ledger.md` v1.3 `sha256:2bd5c3ef…5aed39`, `TSPEC-pdlc-decision-ledger.md` **v1.2** `sha256:fc57bc56…d4c27504`, `DECISIONS-pdlc-decision-ledger.md` **v1.5** `sha256:52580962…584ca0`) |
