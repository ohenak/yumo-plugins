...
| Field | Value |
|---|---|
| Upstream | `REQ → FSPEC → TSPEC → DECISIONS → **PLAN**` (`REQ-pdlc-decision-ledger.md` **v1.10** `sha256:9bc8bc32…05f10d`, `FSPEC-pdlc-decision-ledger.md` **v1.4** `sha256:48691453…a11256`, `TSPEC-pdlc-decision-ledger.md` **v1.3** `sha256:2c84d525…1be49b`, `DECISIONS-pdlc-decision-ledger.md` **v1.6** `sha256:48e73a41…880240`) |
