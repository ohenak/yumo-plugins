...
|---|---|---|---|---|
| pdlc | draft | Claude | 11.5 | 2026-08-07 |
...
| Killed inside the **release** at step 16 | everything, including its terminal row (§4.3 `:557-558` orders release after the append) | the same `reclaimed-stale-lock` / `unknown` |
