...
|---|---|---|---|---|
| pdlc | draft | Claude | 11.6 | 2026-08-10 |
...
| Killed inside the **release** at step 16 | everything, including its terminal row (§4.3 `:566-567` orders release after the append) | the same `reclaimed-stale-lock` / `unknown` |
...
| AC-1.4 | §5.3, §8.5, §8.7, §12.1 | AT-K3, AT-L2, AT-F13, AT-R7 (the "only when" half of §5.3) |
