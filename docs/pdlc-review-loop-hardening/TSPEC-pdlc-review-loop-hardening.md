...
| **Q-05** | **Correctly carried, now bound** to `QUEUE.md` row 9. No product exposure today — §5.9 normalises numeric prefixes — but it needed a successor surface. |
| **Q-09** | **Carried, bound** to `QUEUE.md` row 9, and flagged as the acute one: script-side heading lists drifting from the SKILL templates produce a **false halt**. |
